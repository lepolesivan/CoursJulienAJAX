# J'ai volé ce readme dans un autre projet, il est plus clair que ce que j'aurai pu écrire.

# Toujours installer des packages sur une nouvelle branche, si jamais il y a un truc qui ne fonctionne pas (si les commandes ne sont pas a jour par ex)
